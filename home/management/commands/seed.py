...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # --------------------------
        # 6. Crear carritos con items (carritos genéricos) - CORREGIDO
        # --------------------------
        for i in range(2):
            ...
            for _ in range(random.randint(1, 5)):
                ...
                if not talla_choice:
                    talla_choice = TallaProducto.objects.create(
                        producto=producto_choice, talla="Única", stock=producto_choice.stock
                    )
        ...
        # --------------------------
        # 8. Carritos asociados a usuarios - CORREGIDO
        # --------------------------
        ...
        # Pedidos fijos de ejemplo user1
        pedidos_user1 = [
        ...
        # Pedidos fijos de ejemplo user2
        pedidos_user2 = [
            [(productos[6], 1, "Única"), (productos[12], 2, "Única")], 
            [(productos[15], 2, "Única")],                   
            [(productos[18], 1, "Única"), (productos[19], 1, "Única")], 
        ]
